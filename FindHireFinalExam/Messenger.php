...
<form method="POST" action="core/handleForms.php" id="messageInputContainer">
        <input type="hidden" name="accountID" value="<?php echo $accountID; ?>">
        <input type="hidden" name="postID" value="<?php echo $postID; ?>">
        <textarea name="message" placeholder="Type your message here..." cols="60" rows="5" id="messageInput"></textarea><br><br>
        <button type="submit" name="sendMessage" id="messageButton" style="margin-left: 1.5em;">Send</button><br><br>
